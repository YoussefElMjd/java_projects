...
//            instance = StationsNlDao.getInstance();
...
//    @Test
//    void getAll() {
//        List<StationsDto> expected = List.of(new StationsDto(1, "BEEKKANT"), new StationsDto(2, "ZWARTE VIJVERS"),
//                new StationsDto(3, "GRAAF VAN VLAAND."), new StationsDto(4, "SINT-KATELIJNE"),
